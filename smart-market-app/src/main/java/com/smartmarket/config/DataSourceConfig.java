...
public class DataSourceConfig {
    ...
    @Configuration
    @MapperScan(basePackages = "com.smartmarket.infrastructure.elasticsearch", sqlSessionFactoryRef = "elasticsearchSqlSessionFactory")
    ...
    @Configuration
    @MapperScan(basePackages = "com.smartmarket.infrastructure.dao", sqlSessionFactoryRef = "mysqlSqlSessionFactory")
