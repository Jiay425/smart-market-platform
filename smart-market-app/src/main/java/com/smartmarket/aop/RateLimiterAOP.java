package com.smartmarket.aop;

import com.smartmarket.trigger.api.dto.ActivityDrawResponseDTO;
...
public class RateLimiterAOP {
    ...
    @Pointcut("@annotation(com.smartmarket.types.annotations.RateLimiterAccessInterceptor)")
