...
import com.smartmarket.domain.task.service.ITaskService;
        ...
        try {
            ...
            for (TaskEntity taskEntity : taskEntities) {
                try {
                    ...
                    log.error("定时任务，发送MQ消息失败 userId: {} topic: {} messageId: {}", taskEntity.getUserId(), taskEntity.getTopic(), taskEntity.getMessageId(), e);
