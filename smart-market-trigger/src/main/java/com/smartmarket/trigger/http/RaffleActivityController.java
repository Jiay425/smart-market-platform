...
import com.smartmarket.domain.activity.model.valobj.OrderTradeTypeVO;
import com.smartmarket.domain.activity.service.IRaffleActivityAccountQuotaService;
import com.smartmarket.domain.activity.service.IRaffleActivityPartakeService;
import com.smartmarket.domain.activity.service.IRaffleActivitySkuProductService;
import com.smartmarket.domain.activity.service.armory.IActivityArmory;
import com.smartmarket.domain.award.model.entity.UserAwardRecordEntity;
import com.smartmarket.domain.award.model.valobj.AwardStateVO;
import com.smartmarket.domain.award.service.IAwardService;
import com.smartmarket.domain.credit.model.entity.CreditAccountEntity;
import com.smartmarket.domain.credit.model.entity.TradeEntity;
import com.smartmarket.domain.credit.model.valobj.TradeNameVO;
import com.smartmarket.domain.credit.model.valobj.TradeTypeVO;
import com.smartmarket.domain.credit.service.ICreditAdjustService;
import com.smartmarket.domain.rebate.model.entity.BehaviorEntity;
import com.smartmarket.domain.rebate.model.entity.BehaviorRebateOrderEntity;
import com.smartmarket.domain.rebate.model.valobj.BehaviorTypeVO;
import com.smartmarket.domain.rebate.service.IBehaviorRebateService;
...
import com.smartmarket.domain.strategy.service.armory.IStrategyArmory;
import com.smartmarket.trigger.api.IRaffleActivityService;
import com.smartmarket.trigger.api.dto.*;
import com.smartmarket.types.annotations.DCCValue;
import com.smartmarket.types.annotations.RateLimiterAccessInterceptor;
...
//    @DCCValue("degradeSwitch:close")
    ...
    public Response<ActivityDrawResponseDTO> draw(@RequestBody ActivityDrawRequestDTO request) {
        try {
            ...
            // 3. 抽奖策略 - 执行抽奖
            long coreRaffleStartNanos = System.nanoTime();
            RaffleAwardEntity raffleAwardEntity = raffleStrategy.performRaffle(RaffleFactorEntity.builder()
                    .userId(orderEntity.getUserId())
                    .strategyId(orderEntity.getStrategyId())
                    .endDateTime(orderEntity.getEndDateTime())
                    .build());
            writeCoreRaffleCostHeader(coreRaffleStartNanos);
    ...
    private void writeCoreRaffleCostHeader(long coreRaffleStartNanos) {
        ...
        long costMillis = TimeUnit.NANOSECONDS.toMillis(System.nanoTime() - coreRaffleStartNanos);
        response.setHeader("X-Core-Raffle-Cost-Ms", String.valueOf(costMillis));
    }
