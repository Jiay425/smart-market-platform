...
import com.smartmarket.domain.award.model.aggregate.GiveOutPrizesAggregate;
import com.smartmarket.domain.award.model.aggregate.UserAwardRecordAggregate;
import com.smartmarket.domain.award.model.entity.TaskEntity;
import com.smartmarket.domain.award.model.entity.UserAwardRecordEntity;
import com.smartmarket.domain.award.model.entity.UserCreditAwardEntity;
import com.smartmarket.domain.award.model.valobj.AccountStatusVO;
import com.smartmarket.domain.award.repository.IAwardRepository;
...
import com.smartmarket.infrastructure.dao.po.UserAwardRecord;
import com.smartmarket.infrastructure.dao.po.UserCreditAccount;
import com.smartmarket.infrastructure.dao.po.UserRaffleOrder;
...
public class AwardRepository implements IAwardRepository {
    ...
    public void saveUserAwardRecord(UserAwardRecordAggregate userAwardRecordAggregate) {
        ...
        try {
            ...
            log.error("写入中奖记录，发送MQ消息失败 userId: {} topic: {} messageId: {}", userId, task.getTopic(), task.getMessageId(), e);
