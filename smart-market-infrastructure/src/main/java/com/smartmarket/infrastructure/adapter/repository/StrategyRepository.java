...
import com.smartmarket.domain.strategy.model.entity.StrategyAwardEntity;
import com.smartmarket.domain.strategy.model.entity.StrategyEntity;
import com.smartmarket.domain.strategy.model.entity.StrategyRuleEntity;
import com.smartmarket.domain.strategy.model.valobj.*;
import com.smartmarket.domain.strategy.repository.IStrategyRepository;
import com.smartmarket.domain.strategy.service.rule.chain.factory.DefaultChainFactory;
import com.smartmarket.infrastructure.dao.*;
import com.smartmarket.infrastructure.dao.po.*;
import com.smartmarket.infrastructure.redis.IRedisService;
import com.smartmarket.types.common.Constants;
...
import static com.smartmarket.types.enums.ResponseCode.UN_ASSEMBLED_STRATEGY_ARMORY;
...
public class StrategyRepository implements IStrategyRepository {
    ...
    public StrategyAwardRuleModelVO queryStrategyAwardRuleModelVO(Long strategyId, Integer awardId) {
        String cacheKey = Constants.RedisKey.STRATEGY_AWARD_RULE_MODEL_KEY + strategyId + Constants.UNDERLINE + awardId;
        StrategyAwardRuleModelVO strategyAwardRuleModelVOCache = redisService.getValue(cacheKey);
        if (null != strategyAwardRuleModelVOCache) return strategyAwardRuleModelVOCache;
        ...
        StrategyAwardRuleModelVO strategyAwardRuleModelVO = StrategyAwardRuleModelVO.builder().ruleModels(ruleModels).build();
        redisService.setValue(cacheKey, strategyAwardRuleModelVO);
