...
import com.smartmarket.domain.rebate.model.aggregate.BehaviorRebateAggregate;
import com.smartmarket.domain.rebate.model.entity.BehaviorRebateOrderEntity;
import com.smartmarket.domain.rebate.model.entity.TaskEntity;
import com.smartmarket.domain.rebate.model.valobj.BehaviorTypeVO;
import com.smartmarket.domain.rebate.model.valobj.DailyBehaviorRebateVO;
import com.smartmarket.domain.rebate.repository.IBehaviorRebateRepository;
import com.smartmarket.infrastructure.event.EventPublisher;
import com.smartmarket.infrastructure.dao.IDailyBehaviorRebateDao;
import com.smartmarket.infrastructure.dao.ITaskDao;
import com.smartmarket.infrastructure.dao.IUserBehaviorRebateOrderDao;
import com.smartmarket.infrastructure.dao.po.DailyBehaviorRebate;
import com.smartmarket.infrastructure.dao.po.Task;
import com.smartmarket.infrastructure.dao.po.UserBehaviorRebateOrder;
    ...
    public void saveUserRebateRecord(String userId, List<BehaviorRebateAggregate> behaviorRebateAggregates) {
        ...
        for (BehaviorRebateAggregate behaviorRebateAggregate : behaviorRebateAggregates) {
            ...
            try {
                ...
                log.error("写入返利记录，发送MQ消息失败 userId: {} topic: {} messageId: {}", userId, task.getTopic(), task.getMessageId(), e);
